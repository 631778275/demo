var t = require("../../models/classic.js"), 
s = require("../../models/like.js"), 
i = new t.ClassicModel(), 
e = new s.LikeModel();
...
Page({
    ...
    onLoad: function(t) {
        var s = this;
        console.log(t)
      console.log(s.data.classic)
        i.getLatest(function(t) {
            s._getLikeStatus(t.id, t.type), 
            s.setData({
                classic: t
            });
        });
